...
2. Make sure you add all of the controls from the controls screenshot, otherwise it won't work
3. To play it from the beginning set BPM Multiplier to 1 and startingBeat to 1 (or just copy what's in the base controls image and adjust the offset)

That's it, feel free to push an issue if you notice anything wrong with the files themselves
